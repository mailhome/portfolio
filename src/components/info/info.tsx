            ...
            <div className="width-container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-y-6 gap-x-6 lg:gap-x-12">
                    ...
                    <div className="flex items-center  w-full flex-col lg:items-start lg:justify-start justify-center gap-y-5 ">
                        ...
                        <p className="text-sm md:text-xs tracking-wider text-neutral-800 lg:text-sm lg:tracking-widest xl:text-md dark:text-neutral-100">My name is Henry Abraham, and for the past 3 years, I’ve dedicated myself to the craft of software engineering. I am a proud graduate of the ALX Africa Software Engineering program, where I honed my skills and built a strong foundation in programming. My passion lies in developing software that not only meets users&rsquo; needs but also exceeds their expectations.</p>



                        <p className="text-sm md:text-xs tracking-wider text-neutral-800 lg:text-sm lg:tracking-widest xl:text-md dark:text-neutral-100">I’m skilled in technologies like React.js, C Programming, TypeScript, Python, and APIs, which have enabled me to work on a variety of projects with unique challenges and learning opportunities. I enjoy being part of a team where collaboration and continuous improvement are the norms, as I believe the best ideas and solutions come from shared effort. I’m eager to bring my expertise to a new opportunity where I can create impactful software, learn new things, and make a difference.</p>
