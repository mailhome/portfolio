...
export const AboutItem = ({ desc, icon: Icon, label }: Props) => {
    return (
        <div className="w-full bg-white dark:bg-neutral-100 h-auto rounded-lg py-6 xl:py-8 duration-200 transition-all slide-in-from-right-10">
            <div className="flex gap-y-2 items-center justify-center flex-col ">
                ...
                <p className="text-sm xl:text-lg text-neutral-500">{desc}</p>
            </div>
        </div>
    );
}